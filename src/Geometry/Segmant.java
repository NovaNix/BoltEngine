...
public class Segmant extends Line implements Renderable
{
	...
	public boolean PointOnLine(Vector2f Point)
	{
		if (!IsVertical())
		{
			...
			{
//				System.out.println("Point on line, not vertical: " + (Point.GetX() == PointOnLine.GetX()));
//				System.out.println("Slope: " + Slope);
		...
		{
//			boolean Touching = ((Point.GetX() == Point1.GetX()) && (Point.InRange(GetRange()[0], GetRange()[1])));
//			
//			System.out.println("Point on line, vertical:" + Touching);
//			System.out.println("Slope: " + Slope);
//			System.out.println("In Range: " + (GetRange()[0] <= Point.GetY() && Point.GetY() <= GetRange()[1]));
//			Point1.Print();
//			Point2.Print();
//			
//			Point.Print();
