...
public class AStar 
{
	...
	// The grid consists of a 2d array of booleans, where true means the position is solid
	public static Path PathFind(boolean[][] Grid, int StartX, int StartY, int TargetX, int TargetY, boolean AllowDiagonal)
	{
		...
		{
			FinalPath.AddPoint(FinalNodes.get(i - 1).GetPosition());
		}
